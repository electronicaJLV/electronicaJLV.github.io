...
<tr>
<td><p><?php echo $r["codigodebarras"]; ?></td>
<td><p><?php echo $r["descripcion"]; ?></td>
<td><p><?php echo number_format($r["Precio Bs1"],2,",","."); ?></td>
<td><p><?php echo number_format($r["Precio $1"],2,",","."); ?></td>
<td><p><?php echo number_format($r["cantidad"],0,",","."); ?></td>
</tr>


<?php
    }
  } else { echo "<script>alert('Artículo no encontrado.')</script>';"; }}
?>
</table>
</div>
</body>